...
import cn.tklvyou.guiderobot.utils.CommonUtil;
...
import static cn.tklvyou.guiderobot.widget.toast.ExceptionConstant.EXCEPTION_NOT_INIT;
...
public class ToastUtil {
    ...
    private static void showToast(CharSequence content, boolean isShowRunningForeground, Builder builder) {
        ...
        if (!isShowRunningForeground || (isShowRunningForeground && CommonUtil.isRunningForeground(sContext))) {
            sSystemToast.show();
        }
    }
    ...
    public static class SingleToast {
        ...
        public static final Toast getInstance() {
            ...
            //目前发现Android 9.0版本系统Toast做了单利操作造成短信时间快速Toast 后面无法弹出问题
