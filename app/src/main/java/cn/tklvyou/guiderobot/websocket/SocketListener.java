...
public interface SocketListener {
     ...
     *
     * @param message 文本消息
     * @param data    用户可将数据转成对应的泛型类型，可能为空，具体看用户在 {@link cn.tklvyou.guiderobot.websocket.dispatcher.IResponseDispatcher}
     *                中的实现，默认为空
     ...
     *
     * @param bytes 二进制消息
     * @param data  用户可将数据转成对应的泛型类型，可能为空，具体看用户在 {@link ResponseDispatcher}
     *              中的实现，默认为空
     * @param <T>   IResponseDispatcher 中转换的泛型类型
     */
